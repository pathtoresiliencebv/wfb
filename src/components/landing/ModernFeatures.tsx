...
import { Shield, Users, Leaf, MessageSquare, TrendingUp, Award } from 'lucide-react';
          ...
          <div className="relative z-10 grid grid-cols-6 gap-3">
            ...
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 border-2 hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/20">
              <CardContent className="relative m-auto size-fit pt-6">
                ...
                <h2 className="mt-6 text-center text-3xl font-semibold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                  Gratis
                </h2>
              </CardContent>
            </Card>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-2 hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/20">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h2 className="text-lg font-medium transition">Veilig & Privé</h2>
                  <p className="text-foreground text-sm">
                    Jouw privacy staat voorop. Veilige encryptie en anonieme discussies voor volledige gemoedsrust.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-2 hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/20">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  <h2 className="text-lg font-medium transition">Real-time Updates</h2>
                  <p className="text-foreground text-sm">
                    Blijf op de hoogte met live notificaties en direct zichtbare nieuwe berichten in trending topics.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-foreground">Expert Community</h2>
                    <p className="text-foreground text-sm">
                      Leer van ervaren kwekers en medicinale gebruikers. Duizenden leden delen dagelijks hun kennis.
                    </p>
                  </div>
                </div>
                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6 border-primary/10">
                  <div className="absolute left-3 top-2 flex gap-1">
                    <span className="block size-2 rounded-full border dark:border-white/10 dark:bg-white/10 bg-primary/20 border-primary/30"></span>
                    <span className="block size-2 rounded-full border dark:border-white/10 dark:bg-white/10 bg-primary/20 border-primary/30"></span>
                    <span className="block size-2 rounded-full border dark:border-white/10 dark:bg-white/10 bg-primary/20 border-primary/30"></span>
                  </div>
            ...
            <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-2 hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/20">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium transition">Geverifieerde Leden</h2>
                    <p className="text-foreground text-sm">
                      Betrouwbare community met geverifieerde leveranciers, moderators en ervaren experts.
                    </p>
                  </div>
                </div>
                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-border sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-primary/5 border-primary/20">Expert</span>
                      <div className="ring-primary/30 size-7 ring-4">
                        <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&h=100&fit=crop" alt="Expert lid" />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="ring-primary/30 size-8 ring-4">
                        <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop" alt="Leverancier" />
                      </div>
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-primary/5 border-primary/20">Leverancier</span>
                    </div>
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-primary/5 border-primary/20">Moderator</span>
                      <div className="ring-primary/30 size-7 ring-4">
                        <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=100&h=100&fit=crop" alt="Moderator" />
                      </div>
                    </div>
                  </div>
                </div>
