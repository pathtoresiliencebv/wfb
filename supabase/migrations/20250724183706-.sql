-- Update the color column to allow longer values
ALTER TABLE public.categories ALTER COLUMN color TYPE character varying(20);

-- Insert initial forum categories with corrected color values
